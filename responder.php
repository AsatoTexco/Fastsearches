...
<form class="form_area" action="cadastrar_entrevistado.php" method="POST">

    <!-- levar o id para a proxima pagina  -->
    <input style="display: none" name="id_pesquisa" value="<?=$id_pesquisa?>">
    ...
    <div class="container_area_input">
        ...
        <div class="area_input iemail">
                        ...
                        <input name="nome" required="" class="input">
            ...
            <div class="area_btn">
                <input type="submit" class="btn_sub" value= Próximo>
            </div>
